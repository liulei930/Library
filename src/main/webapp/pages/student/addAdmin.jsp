    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/admin/findAll">管理员编辑</a></li>
                    ...
                    <div class="table-box">
                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建"
                                            onclick="location.href='${pageContext.request.contextPath}/pages/student/admin-add.jsp'">
                        ...
                        <div class=" pull-right">
                            <div class="has-feedback">
                                <form id="find" action="${pageContext.request.contextPath}/admin/findByName"
                                      method="post">
                                    ${message}
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs"
                                                onclick="location.href='${pageContext.request.contextPath}/admin/delete?id=${admin.id}&page=${pageInfo.pageNum}&size=${pageInfo.pageSize}'">
                                            删除
                                        </button>
                                        <button type="button" class="btn bg-olive btn-xs"
                                                onclick="location.href='${pageContext.request.contextPath}/admin/toUpdate?id=${admin.id}'">
                                            编辑
                                        </button>
                                    </td>
                                </tr>
...
<script>
    function changePageSize() {
        ...
        //向服务器发送请求，改变没页显示条数
        location.href = "${pageContext.request.contextPath}/admin/findAll?page=1&size=" + pageSize;
    }
